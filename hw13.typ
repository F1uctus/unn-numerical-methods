...
// TODO: Нужно выразить не lambda, а 1 / lambda, и работать с оценкой для 1 / lambda.
...
// TODO: Добавить график с окружностями спектра.
//       На графике нужно закрасить область спектра, которая удовлетворяет условию устойчивости.
